        ...
        <Row>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-green">
              ...
              <div className="text-value" style={{ height: '70px' }}></div>
            </Card>
          </Col>
          <Col>
            <Card>
              <CardBody>
                ...
                <Col xs="12" sm="10" lg="10">
                    ...
                    <div className="small text-muted">Saint Cloud, MN (3 Miles Away)</div>
                    <div classname= "small text">4 Year, Public</div>
                  </Col>
                </Row>
                <div className="text-value" style={{ height: '30px' }}></div>
              </CardBody>
            </Card>
          </Col>
        </Row>
              ...
              <CardBody>
                <Row>
                  <Col xs="12" sm="10" lg="10">
                    ...
                    <div className="small text-muted">Mankato, MN (114 Miles Away)</div>
              ...
              <CardBody>
                <Row>
                  <Col xs="12" sm="10" lg="10">
                    ...
                    <div className="small text-muted">Omaha, NE (379 Miles Away)</div>
                    <div classname= "big text">4 Year, Public</div>
                  </Col>
                </Row>
                <div className="text-value" style={{ height: '30px' }}></div>
